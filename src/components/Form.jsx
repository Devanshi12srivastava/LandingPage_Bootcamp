...
const handleSubmit = async (e) => {
  ...
  try {
    ...
    alert("Error");
     ...
     return (
    <section id="register" className="py-20 px-4 bg-linear-to-r from-blue-50 to-blue-100">
  ...
  onChange={handleChange}
              ...
              <button type="submit" className="bg-blue-600 text-white text-lg font-semibold py-3 rounded-lg hover:scale-105 transition duration-300 cursor-pointer">
                Submit
              </button>
          ...
          <div className="text-center md:text-left px-15">
            ...
            transition={{ duration: 0.5 }}  className="text-4xl font-bold text-gray-800">
              Join Our Bootcamp 🚀
            </motion.h2>

            <motion.p initial={{ opacity: 0, x: 50 }}
            whileInView={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.5 }}  className="mt-4 text-gray-600">
            ...
            whileInView={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.5 }} className="mt-8 bg-white shadow-xl p-6 rounded-2xl">
